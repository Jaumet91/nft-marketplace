export const SkeletonHomeNFTs = () => (
  <div className="w-52 animate-pulse">
    ...
    <div className="mb-4 h-2.5 w-48 rounded-full bg-gray-300 dark:bg-slate-700"></div>
    <div className="mb-2.5 h-2 rounded-full bg-gray-300 dark:bg-slate-700"></div>
    <div className="mb-2.5 h-2 w-32 rounded-full bg-gray-300 dark:bg-slate-700"></div>
